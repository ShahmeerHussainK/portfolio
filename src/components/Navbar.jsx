  ...
  return (
    <div className="w-full flex flex-col gap-4 justify-between p-4">
      <div className="flex items-center justify-center">
        <h1 className="p-5 rounded-full text-2xl">SHAHEER HASSAN KHAN</h1>
      </div>
      <h1 className="new text-2xl">Creative Communication Manager</h1>
      <div className="flex items-center justify-center">
        <ul className="flex items-center gap-36 padding-6 text-3xl">
          <li>
            <NavLink
              to="/"
